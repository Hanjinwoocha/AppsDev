    ...
    public partial class StudentGradeControl : UserControl
    {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in StudentGradeDataGridView.Rows)
            {
                ...
                // Grade validation
                if (!double.TryParse(gradeStr, out grade) || grade < 1.0 || grade > 5.0)
                {
                    MessageBox.Show("All grades must be numbers between 1.0 and 5.0.", "Validation Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
